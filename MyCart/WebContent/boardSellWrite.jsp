...
<form method="post" action="./write.tb">
	<a href="main.jsp"><img src="images/logo-button_tb.png"
		...
		<table class="table table striped action"
			...
			<tbody>
				<tr colspan="2">
					<td><input type="text" class="form-control" value="SELL"
					...
					<td><input type="text" class="form-control" placeholder="매도희망가"
						name="boardPrice" maxlength="30"></td>
					<td><input type="text" class="form-control" placeholder="최고매도가"
